...
function extractDepartement(baseSrcPath, baseDestPath, codeDep, rawMode = false) {
    ...
    .then(files => {
      ...
      return Promise.map(communesFound, commune => {
        return new Promise((resolve, reject) => {
          extractCommuneWorkers({ baseSrcPath, baseDestPath, codeCommune: commune, rawMode }, err => {
