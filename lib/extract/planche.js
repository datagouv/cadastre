...
async function extractPlanche({ path, codeDep, onFeature, codeCommune, planche }) {
  let tmpDir
  ...
  try {
    ...
    const features = await extractFeatures(THFFilePath, pkg.srsCode, codeDep)
