...
function getGeoJSONPath(basePath) {
  join(basePath, 'etalab-cadastre', 'geojson')
}
...
module.exports = {getGeoJSONPath, getLayerPath, departementPath, communePath, listDepartements, listLayerFilesByDepartement, departementLayerPath}
